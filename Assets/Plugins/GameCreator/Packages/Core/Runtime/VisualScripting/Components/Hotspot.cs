...
namespace GameCreator.Runtime.VisualScripting
{
    ...
    public class Hotspot : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        {
            if (CheckPreExecutionConditions(this.gameObject))
            {
        ...
        {
            if (ActiveInRadius == false || !CheckPreExecutionConditions(this.gameObject))
            {
                this.IsActive = false;
                return;
            }
        ...
        {
            if (ActiveInteractive == false || !CheckPreExecutionConditions(this.gameObject))
            {
                this.IsActive = false;
                return;
            }
        ...
        {
            this.IsActive = ActiveAlways && CheckPreExecutionConditions(this.gameObject);
