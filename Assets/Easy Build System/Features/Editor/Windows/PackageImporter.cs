        ...
        void OnGUI()
        {
            ...
            else if (m_TabIndex == 1)
            {
                ...
                AddIntegrationPackage("Game Creator 2", "Catsoft Works",
                    "https://assetstore.unity.com/packages/tools/game-toolkits/game-creator-2-203069", "EBS_GAMECREATORV2", "Game Creator 2 Integration", "2.16.50", null, null);

                AddIntegrationPackage("Game Creator 2 - Inventory", "Catsoft Works",
                    "https://assetstore.unity.com/packages/tools/game-toolkits/game-creator-2-203069", "EBS_GAMECREATORV2_INVENTORY", "Game Creator 2 Inventory Integration", "2.8.18", null, null);
